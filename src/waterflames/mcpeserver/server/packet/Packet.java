...
public abstract class Packet {
    ...
    public static Packet getPacketInstanceFromID(int id) {
        switch(id){
            case 0x2: return new BroadcastPacket();
            case 0x1C: return new BroadcastResponsePacket();
            case 0x1D: return new BroadcastResponsePacket();
            case 0x5: return new ConnectRequest1Packet();
            case 0x6: return new ConnectResponse1Packet();
            case 0x7: return new ConnectRequest2Packet();
            case 0x8: return new ConnectResponse2Packet();
        }
        return null;
    }
    ...
    public void writeMAGIC(DataOutputStream stream) throws IOException {
        int[] magic = {
            0x0, 0xff, 0xff, 0x0, 0xfe, 0xfe, 0xfe,
            0xfe, 0xfd, 0xfd, 0xfd, 0xfd, 0x12, 0x34,
            0x56, 0x78
        };
